...
- [ ] add red document to the left of blog post links
- [ ] add last modified as a header
- [ ] add name for titles
- [ ] add phone size for kB (lol)
- [ ] fix the nav styles w/ wrapping text title
- [ ] move search bar to below the title
- [ ] make links for posts blue
- [ ] get rid of sidebar
- [ ] add links for about / archive etc in a top header

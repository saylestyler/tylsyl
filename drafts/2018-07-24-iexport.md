...
<!--<img src="/img/sploot1.png">-->

<!--you'll see upon inspektion that the `src` of all `img`s is "127.0.0.1:8080/etc"-->
<!--which if changed to file:/// displays... however chrome-->
<!--has a prob with loading local files as resources.-->
